...
function askQuestion() {
    ...
    if (about_ask.length === asked.length) {
        ...
        console.log(Math.round(interrogation_time));
        let percent = (right_answers*100) / questions_number;
        console.log(percent);

        let text = "Bravo, tu as fini de réviser la leçon !<br><div id='results'><div id='speed'><img id='chrono' src='chronometer.png'><br>" + Math.round(interrogation_time) + " secondes</div><div id='precision'><img id='cible' src='Cible.png'><br>" + percent + "%</div></div>";
        show(text);
